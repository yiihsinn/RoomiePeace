...
- Sidebar：室友名單、狀態、庫存、未結清款項、Garbage Disaster Index、Karma、家事紀錄
- Main：quick prompts、使用者輸入、Agent 回覆、LINE 訊息
- Trace：intent、superpower、tools、memory updates、guardrail result、memory snapshot
